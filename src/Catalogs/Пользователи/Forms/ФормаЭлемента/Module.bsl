...
&НаКлиенте
Процедура ВидимостьДляКонтрагентов()
	
	Если Объект.ПользовательДляКонтрагента Тогда
...
&НаКлиенте
Процедура ПользовательДляКонтрагентаПриИзменении(Элемент)
