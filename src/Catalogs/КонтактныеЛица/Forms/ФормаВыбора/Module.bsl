...
Процедура ОпределитьОтображениеСпискаКонтактныхЛиц(ТолькоСВнешнимДоступом)
	...
	//	| ПО СправочникКонтактныеЛицаКонтрагентов.Ссылка = ВнешниеПользователи.ОбъектАвторизации";
	...
	//| ИЗ Справочник.КонтактныеЛицаКонтрагентов КАК КонтактныеЛицаКонтрагентов " + ТекстИз + ТекстГде;
